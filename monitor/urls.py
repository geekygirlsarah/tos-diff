...
from .views import (
    ...
    LoginVerifyView,
    ManageAttentionView,
    ManageCountryCreateView,
    ManageCountryDeleteView,
    ManageCountryListView,
    ManageCountryUpdateView,
    ManageDashboardView,
    ...
    ManageLanguageCreateView,
    ManageLanguageDeleteView,
    ManageLanguageListView,
    ManageLanguageUpdateView,
...
urlpatterns = [
    ...
    path("manage/countries/", ManageCountryListView.as_view(), name="manage_countries"),
    path(
        "manage/countries/add/",
        ManageCountryCreateView.as_view(),
        name="manage_country_create",
    ),
    path(
        "manage/countries/<int:pk>/",
        ManageCountryUpdateView.as_view(),
        name="manage_country_update",
    ),
    path(
        "manage/countries/<int:pk>/delete/",
        ManageCountryDeleteView.as_view(),
        name="manage_country_delete",
    ),
    path("manage/languages/", ManageLanguageListView.as_view(), name="manage_languages"),
    path(
        "manage/languages/add/",
        ManageLanguageCreateView.as_view(),
        name="manage_language_create",
    ),
    path(
        "manage/languages/<int:pk>/",
        ManageLanguageUpdateView.as_view(),
        name="manage_language_update",
    ),
    path(
        "manage/languages/<int:pk>/delete/",
        ManageLanguageDeleteView.as_view(),
        name="manage_language_delete",
    ),
