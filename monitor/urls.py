...
from .views import (
    ...
    ManageAttentionView,
    ManageDashboardView,
    ManageDocumentCheckView,
    ManageDocumentCreateView,
    ManageDocumentDeleteView,
...
urlpatterns = [
    ...
    path(
        "manage/tags/<int:pk>/delete/",
        ManageTagDeleteView.as_view(),
        name="manage_tag_delete",
    ),
    ...
    path(
        ...
        name="manage_document_check",
    ),
    path(
        "manage/organizations/<int:pk>/delete/",
        ManageOrganizationDeleteView.as_view(),
        name="manage_organization_delete",
    ),
    path(
        "manage/documents/<int:pk>/delete/",
        ManageDocumentDeleteView.as_view(),
        name="manage_document_delete",
    ),
    path(
        "manage/suggestions/<int:pk>/delete/",
        ManageSuggestionDeleteView.as_view(),
        name="manage_suggestion_delete",
    ),
]
